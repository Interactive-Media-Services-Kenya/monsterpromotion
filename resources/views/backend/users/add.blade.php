...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="row "> <!-- Add this line to center the form -->
                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('admin/save-answer') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="10" name="allocated_time" class="form-control"
                                        id="exampleInputEmail1" placeholder="Time Allocated">
                                </div>
