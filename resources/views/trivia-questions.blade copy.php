                        ...
                        <div class="col-lg-9 col-md-9 d-flex align-items-center">
                            <div class="mid-area">
                                ...
                                <div id="question2-container">
                                    ...
                                    <br />
                                    <div style="color:white">
                                        <input type="radio" id="year_1990_1" name="year2" value="1990"
                                            style="display: none;">
                                        <label for="year_1990" data-question="2" class="radio-button">Person 1</label>
                                    </div>
                                    <div style="color:white">
                                        <input type="radio" id="year_1994_1" name="year2" value="1994"
                                            style="display: none;">
                                        <label for="year_1994_1" data-question="2" class="radio-button">Person 2</label>
                                    </div>
                                    <div style="color:white">
                                        <input type="radio" id="year_2020" name="year2" value="2020"
                                            style="display: none;">
                                        <label for="year_2020_1" data-question="2" class="radio-button">Person 3</label>
                                    </div>
                                    <div style="color:white">
                                        <input type="radio" id="year_2023_1" data-question="2" name="year2"
                                ...
                                <div id="question3-container">
                                    ...
                                    <br />
                                    <div style="color:white">
                                        <input type="radio" id="year_1990_q3" data-question="3" name="year_q3"
                                            value="1990" style="display: none;">
                                        <label for="year_1990a" class="radio-button">Answer 2</label>
                                    </div>
                                    <div style="color:white">
                                        <input type="radio" id="year_1990a_q3" data-question="3" name="year_q3"
                                            value="1990" style="display: none;">
                                        <label for="year_1994a" class="radio-button">Answer 4</label>
                                    </div>
                                    <div style="color:white">
                                        <input type="radio" id="year_1990_q3s" data-question="3" name="year_q3"
                                            value="1990" style="display: none;">
                                        <label for="year_2020a" class="radio-button">Answer 5</label>
                                    </div>
                                    <div style="color:white">
                                        <input type="radio" id="year_1990_qd3" data-question="3" name="year_q3"
                                            value="1990" style="display: none;">
                                        <label for="year_2023s" class="radio-button">Answe 6</label>
                                    </div>
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showNextQuestion() {
                var currentQuestion = parseInt(this.getAttribute('data-question'));
                switchQuestion(currentQuestion + 1);
            }

            var radioButtons = document.querySelectorAll('input[type="radio"]');
            radioButtons.forEach(function(radioButton) {
                radioButton.addEventListener('change', showNextQuestion);
            });
